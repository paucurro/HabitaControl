...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La autenticación en dos pasos está activada. Escanea el código QR o introduce la clave en tu aplicación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            ...
            description: 'Introduce el código de 6 dígitos de tu aplicación',

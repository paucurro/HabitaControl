...
export const useTwoFactorAuth = (): UseTwoFactorAuthReturn => {
    ...
    const fetchQrCode = async (): Promise<void> => {
        try {
            ...
            errors.value.push('No se ha podido obtener el código QR');
    ...
    const fetchSetupKey = async (): Promise<void> => {
        try {
            ...
            errors.value.push(
                'No se ha podido obtener la clave de configuración',
            );
    ...
    const fetchRecoveryCodes = async (): Promise<void> => {
        try {
            ...
            errors.value.push(
                'No se han podido obtener los códigos de recuperación',
            );
            recoveryCodesList.value = [];
        }
    };
